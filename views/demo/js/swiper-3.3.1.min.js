        ...
        0 !== b.container.length)) {
            ...
            b.updateSlidesSize = function() {
                ...
                if ("undefined" != typeof b.size) {
                    ...
                    (!b.support.flexbox || b.params.setWrapperSize) && b.wrapper.css(b.isHorizontal() ? {
                        width: b.virtualSize + b.params.spaceBetween + "px"
                    } : {
                    ...
                    0 !== b.params.spaceBetween && b.slides.css(b.isHorizontal() ? b.rtl ? {
                        marginLeft: a + "px"
                    } : {
                        marginRight: a + "px"
                    } : {
            ...
            b.onTouchEnd = function(e) {
                ...
                S) {
                    ...
                    b.params.freeMode) {
                        ...
                        if (i > -b.maxTranslate())
                            return void b.slideTo(b.slides.length < b.snapGrid.length ? b.snapGrid.length - 1 : b.slides.length - 1);
                        if (b.params.freeModeMomentum) {
                            ...
                            if (0 !== b.velocity)
                                p = Math.abs(b.rtl ? (-u - b.translate) / b.velocity : (u - b.translate) / b.velocity);
                            else if (b.params.freeModeSticky)
                    ...
                    if (r > b.params.longSwipesMs) {
                        if (!b.params.longSwipes)
                            return void b.slideTo(b.activeIndex);
                        "next" === b.swipeDirection && b.slideTo(x >= b.params.longSwipesRatio ? w + b.params.slidesPerGroup : w),
                        "prev" === b.swipeDirection && b.slideTo(x > 1 - b.params.longSwipesRatio ? w + b.params.slidesPerGroup : w)
                    } else {
            ...
            b.slideNext = function(e, a, t) {
                return b.params.loop ? b.animating ? !1 : (b.fixLoop(),
                b.container[0].clientLeft,
                b.slideTo(b.activeIndex + b.params.slidesPerGroup, a, e, t)) : b.slideTo(b.activeIndex + b.params.slidesPerGroup, a, e, t)
            }
            ,
            ...
            b.slidePrev = function(e, a, t) {
                return b.params.loop ? b.animating ? !1 : (b.fixLoop(),
                b.container[0].clientLeft,
                b.slideTo(b.activeIndex - 1, a, e, t)) : b.slideTo(b.activeIndex - 1, a, e, t)
            }
            ,
            ...
            b.setWrapperTranslate = function(e, a, t) {
                ...
                i = s(i)),
                b.params.virtualTranslate || b.wrapper.transform(b.support.transforms3d ? "translate3d(" + r + "px, " + i + "px, " + n + "px)" : "translate(" + r + "px, " + i + "px)"),
            ...
            b.getTranslate = function(e, a) {
                ...
                t = s.toString().split(",")),
                "x" === a && (r = window.WebKitCSSMatrix ? s.m41 : parseFloat(16 === t.length ? t[12] : t[4])),
                "y" === a && (r = window.WebKitCSSMatrix ? s.m42 : parseFloat(16 === t.length ? t[13] : t[5])),
                b.rtl && r && (r = -r),
                r || 0)
            }
            ,
            ...
            b.scrollbar = {
                ...
                dragEnd: function() {
                    ...
                    b.params.scrollbarHide && (clearTimeout(e.dragTimeout),
                ...
                setTranslate: function() {
                    if (b.params.scrollbar) {
                        ...
                        b.isHorizontal() ? (a.drag.transform(b.support.transforms3d ? "translate3d(" + e + "px, 0, 0)" : "translateX(" + e + "px)"),
                        a.drag[0].style.width = t + "px") : (a.drag.transform(b.support.transforms3d ? "translate3d(0px, " + e + "px, 0)" : "translateY(" + e + "px)"),
            ...
            b.a11y = {
                ...
                onEnterKey: function(e) {
                    ...
                    b.a11y.notify(b.isEnd ? b.params.lastSlideMessage : b.params.nextSlideMessage)) : a(e.target).is(b.params.prevButton) && (b.onClickPrev(e),
                    b.a11y.notify(b.isBeginning ? b.params.firstSlideMessage : b.params.prevSlideMessage)),
